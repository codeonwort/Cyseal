...
namespace into_d3d
{
	...
	inline DXGI_FORMAT pixelFormat(EPixelFormat inFormat)
	{
		switch (inFormat)
		{
			...
			case EPixelFormat::R32G8X24_TYPELESS        : return DXGI_FORMAT_R32G8X24_TYPELESS;
			...
			case EPixelFormat::R16G16_FLOAT             : return DXGI_FORMAT_R16G16_FLOAT;
			case EPixelFormat::R16_FLOAT                : return DXGI_FORMAT_R16_FLOAT;
